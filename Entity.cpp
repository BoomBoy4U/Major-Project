...
int Entity::get_Health() { return this->health_point; }	//return health value //arian changed 

int Entity::get_SkillPoint() { return this->skill_point; }  		//return skill point value

int Entity::get_Attack() { return this->attack; }     		//return attack value

int Entity::get_Element() { return this->element; }   		//return element of the entity

std::string Entity::get_name() { return this->Name; }  		//return name of the entity

std::string Entity::get_info() { return this->info; }    		//return the info of entity

int Entity::get_damage() { return this->damage; }
