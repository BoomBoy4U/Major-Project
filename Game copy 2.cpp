...
void Game::loadTextures() {
    ...
    sprite.setTexture(enemyTextures.back());
    sprite.setPosition(800.f, 50.f);  // Set position for enemy1
    ...
    enemyTextures.push_back(texture);
    sprite.setTexture(enemyTextures.back());
    sprite.setPosition(800.f, 100.f);  // Set position for enemy2
    enemySprites.push_back(sprite);
    ...
    enemyTextures.push_back(texture);
    sprite.setTexture(enemyTextures.back());
    sprite.setPosition(600.f, 200.f);  // Set position for enemy3
    enemySprites.push_back(sprite);
    ...
    sprite.setTexture(bossTextures.back());
    sprite.setPosition(800.f, 300.f);  // Set position for boss1
    ...
    bossTextures.push_back(texture);
    sprite.setTexture(bossTextures.back());
    sprite.setPosition(600.f, 400.f);  // Set position for boss2
    bossSprites.push_back(sprite);
    ...
    bossTextures.push_back(texture);
    sprite.setTexture(bossTextures.back());
    sprite.setPosition(800.f, 500.f);  // Set position for boss3
    bossSprites.push_back(sprite);
    ...
    bossTextures.push_back(texture);
    sprite.setTexture(bossTextures.back());
    sprite.setPosition(800.f, 600.f);  // Set position for boss4
    bossSprites.push_back(sprite);
}
            ...
            for (size_t i = 0; i < this->buttons.size(); i++) {
                if (this->buttons[i].getGlobalBounds().contains(this->mousePosView)) {
                    if (!enemies.empty() && enemies[0]->get_Health() > 0 && player->get_Health() > 0) {
                        ...
                        // Gain points
                        if (i == 0){if(currentLevel==1)std::cout << "dodge not permitted in level 1" << std::endl;}
